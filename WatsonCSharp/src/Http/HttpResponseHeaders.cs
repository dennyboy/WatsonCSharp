...
namespace LittleH.WatsonCSharp.src.Http
{
    /// <summary>
    /// HTTP Response Headers that include the dashes
    /// </summary>
    class HttpResponseHeaders
    {
        ...
        ///<summary>Provides authorization token</summary>
        public const string XWatsonAuthorizationToken = "X-Watson-Authorization-Token";
